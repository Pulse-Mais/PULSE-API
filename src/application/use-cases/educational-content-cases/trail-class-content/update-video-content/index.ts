export { UpdateTrailClassVideoContentInputDTO } from './dto/update-trail-class-video-content-input-dto';
export { UpdateTrailClassVideoContentOutputDTO } from './dto/update-trail-class-video-content-output-dto';
export { TrailNotFoundApplicationException } from '../../../../application-exceptions/use-cases-application-exceptions/trail-not-found-app-exception';
